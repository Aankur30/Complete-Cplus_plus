...
int main()
{
    ...
    // std::cout << "numbers capacity : " << numbers.capacity() << std::endl;//No capacity method in the array
    ...
    std::cout << " numbers : ";
    print_collection(numbers);
    numbers.fill(1000); // can fill with 1000 as all the elements are filled
    std::cout << " numbers : ";
    print_collection(numbers);
