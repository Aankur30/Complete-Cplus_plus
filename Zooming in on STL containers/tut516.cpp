...
int main()
{
    ...
    std::cout << " numbers[3] : " << numbers[3] << std::endl;       // No bound check may get a crash
    std::cout << " numbers.at(3) : " << numbers.at(3) << std::endl; // Bound check throws an exception
    ...
    print_collection(numbers);
    std::cout << " numbers capacity : " << numbers.capacity() << std::endl; // bring capacity to the number of elements
