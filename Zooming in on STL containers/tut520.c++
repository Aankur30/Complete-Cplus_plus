...
int main()
{
    ...
    std::cout << " first : " << *result.first << std::endl;  // first will give the value of the inserted value
    std::cout << " second : " << result.second << std::endl; // second will give true of false that insertion was successful or not
