...
template <typename T = int, size_t maximum = 10>//default parameters only required at the time of the class declaration not the time of the method implementation
//order is the most necessary element of the class template declaration
class BoxContainer
{
